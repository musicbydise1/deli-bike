  ...
  return (
    <Paper sx={{ p: 3, m: 15 }} style={{ marginTop: '7rem' }}>
      ...
      <Typography variant="body1">
        <strong>Дата начала:</strong> {new Date(order.startDate).toLocaleDateString('ru-RU')}
      </Typography>
      <Typography variant="body1">
        <strong>Дата окончания:</strong> {new Date(order.endDate).toLocaleDateString('ru-RU')}
      </Typography>
      <Typography variant="body1">
      ...
      <Typography variant="body1">
        <strong>Создано:</strong> {new Date(order.createdAt).toLocaleString('ru-RU')}
      </Typography>
