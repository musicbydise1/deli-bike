            ...
            {!hasAccessToken ? (
                <div>
                    <Link href={roleCookie === "courier" ? "/login" : "/other-login"}>
                        <Button variant="primary" className="w-full !ml-0">Войти</Button>
                    </Link>
                    <span className="text-[14px] mt-2 text-red-500">Чтобы произвести аренду вам необходимо войти в систему</span>
                </div>
            ) : (
