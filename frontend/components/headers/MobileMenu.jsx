        ...
        >
          {showMenu && (
              <div className="mm-panels">
                ...
                >
                  ...
                  <div className="mt-3">
                    <Link href={userRole === "courier" ? "/login" : "/other-login"}>
                      <Button className="ml-0 w-full" variant="primary-outline">{t("login")}</Button>
                    </Link>
                  </div>

                  <div className="location-switcher mt-2">
                    <div className="dropdown">
                      <button className="dropdown-togglee location-button" onClick={toggleLocationDropdown}>
                        <Image
                            src={
                              location === "kz"
                  ...
                  <div className="language-switcher mt-2">
                    <div className="dropdown">
                      <button className="dropdown-togglee language-button" onClick={toggleLanguageDropdown}>
                ...
                <div
                    className={`mm-panel ${memuOpen == 6 ? "mm-panel_opened" : "mm-hidden"}`}
                >
                  <div
                      className="mm-navbar mm-navbar_sticky"
                      onClick={() => setMemuOpen((pre) => (pre == 5 ? -1 : 5))}
