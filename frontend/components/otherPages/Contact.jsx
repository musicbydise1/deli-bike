            ...
            <div className="right-box">
              <div className="row">
                ...
                <div className="contact-column col-lg-6 col-md-12 col-sm-12">
                  <div className="inner-column">
                    <div className="boxcar-title">
                      <h6 className="title">Контактные данные</h6>
                      <div className="text">
                        Свяжитесь с нами любым удобным способом, и мы ответим на все вопросы.
                      </div>
                    </div>
                    ...
                    <div className="content-box">
                      ...
                      <div className="text">info@deli-bike.kz</div>
                    </div>
                    <div className="content-box">
                      <h6 className="title">
                      <span className="icon">
                      ...
                      <div className="text">+7 (727) 390 29 27</div>
                    </div>
                    <div className="social-icons">
                      <h6 className="title">Следите за нами</h6>
