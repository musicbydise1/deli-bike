      ...
      <div className="boxcar-container">
        ...
        <div className="boxcar-title-three wow fadeInUp">
          <ul className="breadcrumb">
            <li>
              <Link href={`/`}>{t('contact.breadcrumb.home')}</Link>
            </li>
            <li>
              <span>/</span>
            </li>
            <li>
              <span>{t('contact.breadcrumb.contacts')}</span>
            </li>
          </ul>
          ...
          <div className="right-box">
            <div className="row">
                  ...
                  <form onSubmit={e => e.preventDefault()} className="row">
                    ...
                    <div className="col-lg-12">
                      <div className="form_boxes v2">
                        <label>{t('contact.form.comment')}</label>
                        <textarea
                          name="message"
                    ...
                    <div className="form-submit">
                      <button type="submit" className="theme-btn">
                        ...
                        <Image alt="Стрелка" width={14} height={14} src="/images/arrow.svg" />
                      </button>
                    </div>
                  </form>
                </div>
              ...
              <div className="contact-column col-lg-6 col-md-12 col-sm-12">
                <div className="inner-column">
                  <div className="boxcar-title">
                    <h6 className="title">{t('contact.info.title')}</h6>
                    <div className="text">{t('contact.info.description')}</div>
                  </div>
                  <div className="content-box">
                    ...
                    <div className="text">{t('contact.info.address.value')}</div>
                  </div>
                  <div className="content-box">
                    <h6 className="title">
                      <span className="icon">
                    ...
                    <div className="text">{t('contact.info.email.value')}</div>
                  </div>
                  <div className="content-box">
                    <h6 className="title">
                      <span className="icon">
                    ...
                    <div className="text">{t('contact.info.phone.value')}</div>
                  </div>
                  <div className="social-icons">
                    <h6 className="title">{t('contact.info.social.title')}</h6>
        ...
        {/* Конец секции отправки сообщения */}
        {/* Секция офисов */}
