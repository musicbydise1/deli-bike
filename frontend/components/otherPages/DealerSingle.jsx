...
const hours = [
  ...
  { day: "Понедельник", time: "10:00 - 17:00" },
  { day: "Вторник", time: "10:00 - 17:00" },
  { day: "Среда", time: "10:00 - 17:00" },
  { day: "Четверг", time: "10:00 - 17:00" },
  { day: "Пятница", time: "10:00 - 17:00" },
                ...
                <div className="inner-column">
                  <div className="brand-box">
                    ...
                    <div className="content-box">
                      <h3 className="title">Вакансия: Менеджер по продажам</h3>
                      ...
                      <div className="text">
                        Наша компания ищет талантливых специалистов для динамичного развития.
                  ...
                  <div className="description-sec">
                    <h4 className="title">Описание вакансии</h4>
                    <div className="text two">
                      Мы ищем энергичного и целеустремлённого специалиста для работы в нашем офисе.
                    </div>
                    <div className="text">
                      Основные обязанности включают ведение переговоров, обслуживание клиентов и выполнение планов по продажам. Мы предлагаем конкурентную заработную плату, социальный пакет и возможности для профессионального роста.
                    </div>
                  </div>
                  <div className="service-box">
                    <h4 className="title">Что мы предлагаем</h4>
                    <div className="list-sec">
                      <div className="service-list two">
                        <h6 className="inner-title">Условия работы</h6>
                      ...
                      <div className="service-list">
                        <h6 className="inner-title">Дополнительные бонусы</h6>
                        <div className="list-box">
                          <ul className="list two">
              ...
              <div className="col-xl-4 col-lg-12 col-md-12 col-sm-12">
                <div className="side-bar">
                  ...
                  <div className="schedule-sec">
                    <h6 className="title">График работы</h6>
