...
export default function RegisterStep({
    ...
    const isStep2Valid =
        Boolean(registerData.idCardFrontImage) &&
        Boolean(registerData.idCardBackImage);
                    ...
                    <>
                        ...
                        <div className="form_boxes" style={{ position: "relative" }}>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setRegisterData({ ...registerData, patronymic: e.target.value })
                                }
                            />
                            {registerData.patronymic &&
                                registerData.patronymic.trim() !== "" && (
                                    <AiOutlineCheckCircle
                                        style={{
                                            position: "absolute",
                                            right: "10px",
                ...
                {step === 2 && (
                    <>
                        ...
                        <div style={{ display: "flex", gap: "1rem" }}>
                            ...
                            <div
                                className="form_boxes upload-box"
                            ...
                            >
                                ...
                                <div
                                    ...
                                    onClick={() =>
                                        document.getElementById("idCardFrontImage").click()
                                    }
                                >
                            ...
                            >
                                ...
                                <div
                                    ...
                                    onClick={() =>
                                        document.getElementById("idCardBackImage").click()
                                    }
                                >
