...
export default function Location() {
  return (
    <>
      ...
      <div className="text">Суюнбая . Сегодня открыто с 9:00 до 18:00.</div>
