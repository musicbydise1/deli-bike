        ...
        <div className="row">
          ...
          <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp">
              ...
              <div className="content-box">
                <h6 className="title">Ассортимент</h6>
                <div className="text">
                  Отработанная и адаптированная линейка электровелосипедов и
                  аксессуаров для работы курьеров
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="100ms">
              ...
              <div className="content-box">
                <h6 className="title">Штат</h6>
                <div className="text">
                  20 сотрудников, включая сервисменов, водителей, административных работников
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="300ms">
              ...
              <div className="content-box">
                <h6 className="title">Контроль качества и система менджемента</h6>
                <div className="text">
                  Производство на базе собственных техзаданий и
                  документации для тяжёлых условий эксплуатации (горная местность)
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="300ms">
              ...
              <div className="content-box">
                <h6 className="title">Сервисный центр</h6>
                <div className="text">
                  Собственный сервисный центр в Алматы
                  планируются открытия в Астане,  Карагананде  и др.
                </div>
              </div>
            </div>
          </div>
