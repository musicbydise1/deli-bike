                    ...
                    <div className="row">
                        ...
                        <div className="content-column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                            <div className="inner-column wow fadeInUp">
                                <h2 className="title">
                                    Идеальные решения для корпоративных клиентов
                                </h2>
                                <div className="text">
                                    Станьте нашим партнером и предоставьте вашей команде гибкие и экологичные варианты
                                    передвижения.
                                    Независимо от того, нужен ли вам надежный транспорт для повседневной работы или для
                                    специальных мероприятий,
                                    наши корпоративные решения созданы, чтобы соответствовать потребностям вашего
                                    бизнеса.
                                    Наслаждайтесь эксклюзивными преимуществами, выгодными тарифами и персональной
                                    поддержкой для вашей компании.
                                </div>
