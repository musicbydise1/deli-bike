                  ...
                  <div className="desc-boxes">
                    <div className="desc-box">
                      ...
                      <div className="texxt-box">
                        ...
                        <div className="text">
                          Превратите электровелосипед в передвижную рекламу. Логотип заметен и
                          работает лучше любого баннера — всегда на виду. Размещайте логотип на раме
                          (1), АКБ (2) и термоконтейнере (3), чтобы выделиться еще сильнее.
                        </div>
                      </div>
                    </div>
                    <div className="desc-box">
                      ...
                      <div className="texxt-box">
                        ...
                        <div className="text">
                          Реклама на вашем транспорте приносит доход, а поездки превращаются в
                          источник прибыли.
                        </div>
                      </div>
                    </div>
