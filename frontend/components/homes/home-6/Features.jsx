          ...
          <div className="row">
            ...
            <div className="choose-us-block-four col-lg-3 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp">
                ...
                <div className="content-box">
                  <h6 className="title">54%</h6>
                  <div className="text">
                    Увеличение скорости доставки в сравнении с пешим курьером
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="choose-us-block-four col-lg-3 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="100ms">
                ...
                <div className="content-box">
                  <h6 className="title">37%</h6>
                  <div className="text">
                    увеличение скорости доставки
                    в сравнении с курьером на обычном велосипеде
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="choose-us-block-four col-lg-3 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="200ms">
                ...
                <div className="content-box">
                  <h6 className="title">50%</h6>
                  <div className="text">
                    сокращение затрат
                    на обслуживании и ФОТ курьеров и сервисменов
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="choose-us-block-four col-lg-3 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="300ms">
                ...
                <div className="content-box">
                  <h6 className="title">27%</h6>
                  <div className="text">
                    экономия времени
                    нет простоя в работе курьеров
                  </div>
                </div>
              </div>
            </div>
