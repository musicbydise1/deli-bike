  ...
  return (
    <section className="blog-section-two pt-0 section-radius-bottom bg-white">
      <div className="boxcar-container">
        ...
        <div className="row">
          {/* blog-blockt-two */}
          <div className="blog-blockt-two col-lg-4 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp">
              <h3 className="title">Депозитная Модель</h3>
              <div className="text">
                <ul>
                  <li>
                    Заключаем соглашение о сотрудничестве с компанией, которая оплачивает аренду
                  </li>
                  <li>Заключаем договор с курьером</li>
                  <li>За транспорт отвечает курьер</li>
                </ul>
              </div>
          ...
          <div className="blog-blockt-two col-lg-4 col-md-6 col-sm-12">
            <div className="inner-box two wow fadeInUp" data-wow-delay="100ms">
              <h3 className="title">Гарантийное Модель</h3>
              <div className="text">
                <ul>
                  <li>Заключаем договор с компанией, которая оплачивает аренду</li>
                  <li>Мы доставляем транспорт бесплатно</li>
                  <li>За транспорт отвечает компания</li>
                </ul>
              </div>
              <Link href={`/pricing`} className="read-more">
                Сотрудничать
          ...
          <div className="blog-blockt-two col-lg-4 col-md-6 col-sm-12">
            <div className="inner-box three wow fadeInUp" data-wow-delay="100ms">
              <h3 className="title">Тарифная модель</h3>
              <div className="text">
                <li>Заключаем договор с курьером, который оплачивает аренду</li>
                <li>Мы предоставляем промо-матрериалы и скидки для компаний</li>
                <li>За транспорт отвечает курьер</li>
              </div>
              <Link href={`/pricing`} className="read-more">
                Сотрудничать
