...
export default function FormModalContent() {
  ...
  const phoneMask = locationState === 'by' ? '+375 (99) 999-99-99' : '+7 (999) 999-99-99';
  ...
  const formTitle =
    userRole === 'corporate' ? 'Оставьте заявку, чтобы стать нашим партнёром' : 'ЗАПОЛНИТЕ ФОРМУ';
  ...
  return (
    <div className={styles.formWrap}>
      ...
      <p className={styles.formSubtitle}>Менеджер свяжется с вами в течение дня</p>
      <form onSubmit={handleSubmit}>
        ...
        {userRole === 'corporate' && (
          <div className={styles.formGroup}>
            <label className="modalLabel" htmlFor="companyName">
              Название компании
            </label>
            <input
              type="text"
        ...
        <div className={styles.formGroup} style={{ position: 'relative' }}>
          ...
          >
            <Image
              src={
                locationState === 'by' ? '/images/belarus-flag.svg' : '/images/kazakhstan-flag.svg'
              }
