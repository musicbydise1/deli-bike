          ...
          <div className="uper-box">
            <div className="content-box">
              <figure className="icon">
                <a href="#">
                  <Image alt="" src="/images/resource/search.png" width={94} height={94} />
                </a>
              </figure>
              <div className="boxcar-title light">
                <h2>Брендирование Транспорта</h2>
                <div className="text">Опция доступна для юридические лиц</div>
              </div>
            </div>
          </div>
          <div className="right-box wow fadeInUp" data-wow-delay="100ms">
            <div className="boxcar-title light wow fadeInUp"></div>
