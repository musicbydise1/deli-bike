      ...
      {isLoading ? (
        ...
        <>
          <p className="code-step-subtitle">
            SMS с кодом отправлено. Если не получите сообщение в течение 2 минут, вам позвонит наш
            робот. Последние 4 цифры номера будут кодом для входа. Не нужно отвечать на звонок.
          </p>
