...
export default function ListingMap1() {
  ...
  const CustomMarker = ({ elm }) => {
    return (
      <div className="map-marker-container" onClick={() => locationHandler(elm)}>
              ...
              <div className="map-listing-item">
                <div className="inner-box">
                  ...
                  <div className="content">
                    <h3>
                      <Link href={`/bike/${getLocation.id}`}>{getLocation.title}</Link>
                    </h3>
                    <ul className="job-info">
                      <li>
                        <span className="icon flaticon-briefcase" /> {getLocation.specs[0].text}
                      </li>
                      <li>
