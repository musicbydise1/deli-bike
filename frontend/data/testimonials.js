...
export const clients = [
  {
    ...
    icon: "fa-user",
    styleClass: "",
    description: "Работайте с нами, чтобы получить надежный и удобный транспорт для выполнения заказов."
  },
  {
    title: "Корпоративные клиенты",
    icon: "fa-users",
    styleClass: "",
    description: "Мы понимаем важность точности и эффективности для вашего бизнеса."
  }
];
