...
import { TranslationsService } from '../../translations/service/translations.service'; // <-- импорт
...
export class PriceCategoryService {
    ...
    async findAll(): Promise<PriceCategory[]> {
        ...
        for (const category of categories) {
            const translations = await this.translationsService.findAllForEntity('price_category', category.id);
