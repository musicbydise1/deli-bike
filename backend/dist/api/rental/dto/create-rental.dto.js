...
__decorate([
    ...
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], CreateRentalDto.prototype, "bikeId", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_transformer_1.Transform)(({ value }) => new Date(value)),
    (0, class_validator_1.IsDate)({ message: 'startDate must be a valid Date instance' }),
    __metadata("design:type", Date)
], CreateRentalDto.prototype, "startDate", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_transformer_1.Transform)(({ value }) => new Date(value)),
    (0, class_validator_1.IsDate)({ message: 'endDate must be a valid Date instance' }),
    __metadata("design:type", Date)
