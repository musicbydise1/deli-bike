...
let CurrencySeeder = class CurrencySeeder {
    ...
    generateData() {
        const data = [];
        Object.keys(currency_entity_1.CurrencyCodes).forEach((key) => {
            data.push({
                code: currency_entity_1.CurrencyCodes[key],
                name: currency_entity_1.CurrencyNames[key],
            });
        });
        return data;
    }
...
//# sourceMappingURL=currency.seeder.js.map